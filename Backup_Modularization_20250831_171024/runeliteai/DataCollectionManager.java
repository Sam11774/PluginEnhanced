...
public class DataCollectionManager
{
     ...
     */
    void collectWorldData(TickDataCollection.TickDataCollectionBuilder builder)
    {
        // World environment
     ...
     * Collect input data
     */
    void collectInputData(TickDataCollection.TickDataCollectionBuilder builder)
    {
     ...
     */
    void calculateMovementAnalytics(TickDataCollection.TickDataCollectionBuilder builder)
    {
        try {
            Player localPlayer = client.getLocalPlayer();
            if (localPlayer == null || localPlayer.getWorldLocation() == null) {
     ...
     */
    void collectCombatData(TickDataCollection.TickDataCollectionBuilder builder)
    {
     ...
     * Collect social data
     */
    void collectSocialData(TickDataCollection.TickDataCollectionBuilder builder)
    {
     ...
     */
    void collectInterfaceData(TickDataCollection.TickDataCollectionBuilder builder)
    {
     ...
     */
    void collectSystemMetrics(TickDataCollection.TickDataCollectionBuilder builder)
    {
     ...
     */
    TickDataCollection createErrorTickData(Integer sessionId, int tickNumber, Exception error)
    {
